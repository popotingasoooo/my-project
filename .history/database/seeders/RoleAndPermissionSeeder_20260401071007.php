...
class RoleAndPermissionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        foreach (['manage-users','view-users','manage-roles',
            'view-roles','view-logs','manage-tasks','view-tasks','update-task-status',] as $permission) {
        ...
        $staff->syncPermissions(['view-users','view-tasks','update-task-status']); // Assign specific permissions to staff
