...
class RoleAndPermissionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        foreach (['manage-users','view-users','manage-roles',
            'view-roles','view-logs','manage-tasks','view-tasks','update-tasks-status',] as $permission) {
        ...
        $staff->syncPermissions(['view-users','view-tasks','update-tasks-status']); // Assign specific permissions to staff
